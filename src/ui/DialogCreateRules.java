...
public class DialogCreateRules extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(10, 10, 10)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel2).addComponent(txtRulesName,
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(200, 200, 200).addComponent(btnAcceptRules)
	...
	private void btnAcceptRulesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAcceptRulesActionPerformed
		...
		String compileResult = Interpreter.compileRules(txtRulesName.getText());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DialogCreateRules.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
